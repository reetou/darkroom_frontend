...
const DarkroomPhotoPage: NextPage<
...
export async function getServerSideProps(context: GetServerSidePropsContext) {
  ...
  try {
    const res = await axios.post(`${NEXT_API_URL}/api/event_gallery/photo`, {
      restaurant: context.query.restaurant,
      id: context.query.id,
    });
...
export default DarkroomPhotoPage;
